...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Menu::create(['id' => 46, 'name' => 'Menus','slug' => '/', 'grupo' => 'menus','icono' => 'fa-solid fa-screwdriver-wrench','parent' => '0','order' => '3','href' => '0',]);
        ...
        Menu::create(['id' => 47, 'name' => 'Recetas', 'slug' => 'recetas.index', 'grupo' => 'recetas-clients', 'icono' => 'fa-solid fa-users', 'parent' => '46', 'order' => '0', 'href' => '0', ]);
