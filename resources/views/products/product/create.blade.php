...
@section('content')
    ...
    {!! Form::open(['route' => 'product.store', 'method' => 'POST', 'novalidate', 'class' => 'needs-validation']) !!}
    <div class="row g-4">
        <x-cards>
            <div class="row g-4">
                <div class="col-md-6">
                    <label class="form-label">Nombre del producto</label>
                    {!! Form::text('name_product', null, [
                        'autocomplete' => 'off',
                        'required',
                ...
                <div class="col-md-3">
                    ...
                    {!! Form::number('price_product', null, [
                        'autocomplete' => 'off',
                        'required',
                        'placeholder' => 'Ingrese el el precio del producto',
                        'class' => 'form-control form-control-sm',
                        'min' => '0',
                        'step' => '0.01',
                    ]) !!}
                ...
                <div class="col-md-3">
                    ...
                    {!! Form::select('id_warehouse', $getWarehouses, null, [
                        'required',
                ...
                <div class="col-md-3">
                    ...
                    {!! Form::select('id_unit_product', $getUnits, null, [
                        'required',
                        'class' => 'form-select form-control-sm',
                        'placeholder' => 'Seleccione',
                    ]) !!}
